...
- Approved visual direction (2026-09-07): black/charcoal surfaces, warm-gray text, muted amber accents, Inter for interface/prose, and JetBrains Mono for code. Homepage title: `What Claude/Codex Made`. The user approved the full `docs/spec/ROOT_SPEC.md` and authorized slice 1 on 2026-09-07; follow its page layouts, content rules, and serial implementation plan.
