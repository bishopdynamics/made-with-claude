...
- First run is complete. The current GitHub workflow checks changes; deployment will be added as part of the launch implementation. The user accepted Half-Life: Continuum Edition portfolio v1 as release-ready on 2026-09-08; more gallery images belong to v2. BeamVM's write-up is approved and paused while the user prepares images. FantasyBoy is the next active onboarding project, using `docs/spec/FEATURE_SPEC_fantasyboy_onboarding.md`; website launch remains pending.
