...
- Approved next update (2026-09-10): `docs/spec/FEATURE_SPEC_project_video.md` adds the user's Continuum YouTube video with minimal supported player options and usable playback controls. The provider-managed player is explicitly requested; site-owned images remain local. Implemented and verified locally on 2026-09-10 (committed, not pushed); publish only after the user reviews the rendered update.
