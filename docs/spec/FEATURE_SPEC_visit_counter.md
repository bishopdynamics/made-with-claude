...
- **Status:** draft
- **Request:** On 2026-09-10 the user asked for a "classic site visit counter". Showing the count on the page is not a priority; they want visits tracked somehow. After two research rounds they chose hosted, privacy-friendly analytics and picked GoatCounter, created the account, and recorded the supplied snippet in `docs/TODO.md`.
...
- 2026-09-10 — created after the user chose GoatCounter and supplied the account snippet. Awaiting approval.
